...
My goals are quite simple, to "master" C++, and to start getting good at CSS and JavaScript.
My overall goal is to make an application with a large purpose, including a good backend and frontend. 
Even though AI APIs are used in things like `nix`, `ncli` and `pyramid`, I am against using AI for coding. 
